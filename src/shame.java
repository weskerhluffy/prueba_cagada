...
// XXX: https://github.com/AhmadElsagheer/UVa-Solutions/blob/master/v107/Test_UVa10731.java
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		while (true) {
			...
			while (N-- > 0) {
				...
				int[] next = new int[5];
				for (int i = 0; i < 5; i++) {
					next[i] = st.nextToken().charAt(0) - 'A';
					valid[next[i]] = true;
				}
...
class Component implements Comparable<Component> {
	...
	Component(ArrayList<Integer> x, int u) {
		nodes = x;
		head = u;
//		System.out.println("mierda " + x + " cabeza " + (char)(u+'A'));
	}
